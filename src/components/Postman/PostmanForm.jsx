...
import {DeleteTwoTone, DownOutlined, EditTwoTone, QuestionCircleOutlined, SendOutlined} from '@ant-design/icons';
...
export default ({form, body, setBody, headers, setHeaders, bordered = false}) => {
